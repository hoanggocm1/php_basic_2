                                ...
                                <div class="form-group">
                                    <select name="parent_ID" id="listProduct" onchange="location = this.value;" class="form-control">
                                        ...
                                        <?php while ($name_accounts = mysqli_fetch_assoc($accounts)) :  ?>
                                            <option value="listProductByID.php?id=<?php echo $name_accounts['id']; ?>"><?php echo $name_accounts['account_name'];
                                                                                                                        if ($name_accounts['roleID'] == 1 && $name_accounts['id'] != key($_SESSION['account'])) {
                                                                                                                            echo ' - Admin';
                                                                                                                        } elseif ($name_accounts['roleID'] != 1) {
                                                                                                                            echo ' - User';
                                                                                                                        } else {
                                                                                                                            echo ' - Admin (tôi)';
                                                                                                                        } ?></option>
